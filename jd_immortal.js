...
let scoreToBeans = $.isNode()?(process.env.JD_IMMORTAL_SCORE || 0):$.getdata('scoreToBeans') || 20; //兑换多少数量的京豆（20或者1000），0表示不兑换，默认兑换20京豆，如需兑换把0改成20或者1000，或者'商品名称'(商品名称放到单引号内)即可
...
const inviteCodes = [
  `43xIs4YwE5Z7DsWOzDSL_xTdlUgR5n4iZO4htmXkyc9CG4cZB9wUMAhzYlL985ySeeKg@51xIs4YwE5Z7G88223XAAVdjySQd6eaDT3pGqv7Zbe-bx6FP2i-_ls_lCtEe_NWpxuP4yciW4Z4JG-Twd6`,
  `43xIs4YwE5Z7DsWOzDSL_xTdlUgR5n4iZO4htmXkyc9CG4cZB9wUMAhzYlL985ySeeKg@51xIs4YwE5Z7G88223XAAVdjySQd6eaDT3pGqv7Zbe-bx6FP2i-_ls_lCtEe_NWpxuP4yciW4Z4JG-Twd6`
];
!(async () => {
  await requireConfig();
